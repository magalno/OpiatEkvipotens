...
public class Converter extends ActionBarActivity {
    ...
    public static final String[] opioids = {"morfin po",
            "ketobemidon po",
            "kodein po",
            "tramadol po",
            "oxykodon po",
